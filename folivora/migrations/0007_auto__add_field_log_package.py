...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Log.package'
        db.add_column('folivora_log', 'package',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['folivora.Package'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Log.package'
        db.delete_column('folivora_log', 'package_id')
