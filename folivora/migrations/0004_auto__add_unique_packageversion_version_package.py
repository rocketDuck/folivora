...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PackageVersion', fields ['version', 'package']
        db.create_unique('folivora_packageversion', ['version', 'package_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PackageVersion', fields ['version', 'package']
        db.delete_unique('folivora_packageversion', ['version', 'package_id'])
