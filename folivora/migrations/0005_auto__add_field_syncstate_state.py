...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SyncState.state'
        db.add_column('folivora_syncstate', 'state',
                      self.gf('django.db.models.fields.CharField')(default='running', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SyncState.state'
        db.delete_column('folivora_syncstate', 'state')
