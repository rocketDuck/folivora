...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Package', fields ['name', 'provider']
        db.create_unique('folivora_package', ['name', 'provider'])

        # Adding unique constraint on 'ProjectDependency', fields ['project', 'package']
        db.create_unique('folivora_projectdependency', ['project_id', 'package_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProjectDependency', fields ['project', 'package']
        db.delete_unique('folivora_projectdependency', ['project_id', 'package_id'])

        # Removing unique constraint on 'Package', fields ['name', 'provider']
        db.delete_unique('folivora_package', ['name', 'provider'])
