...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectDependency.update'
        db.alter_column('folivora_projectdependency', 'update_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['folivora.PackageVersion'], null=True))

    def backwards(self, orm):

        # Changing field 'ProjectDependency.update'
        db.alter_column('folivora_projectdependency', 'update_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['folivora.PackageVersion']))
