...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectMember.mail'
        db.add_column('folivora_projectmember', 'mail',
                      self.gf('django.db.models.fields.EmailField')(max_length=254, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectMember.mail'
        db.delete_column('folivora_projectmember', 'mail')
    ...
    models = {
        ...
        'folivora.projectmember': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mail': ('django.db.models.fields.EmailField', [], {'max_length': '254', 'null': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['folivora.Project']"}),
