...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('folivora_package', 'normalized_name', self.gf('django.db.models.fields.CharField')(default=None, unique=True, max_length=255, null=False))

    def backwards(self, orm):

        # Changing field 'Package.normalized_name'
        db.alter_column('folivora_package', 'normalized_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, null=True))
    ...
    models = {
        ...
        'folivora.syncstate': {
            ...
            'state': ('django.db.models.fields.CharField', [], {'default': "'running'", 'max_length': '255'}),
