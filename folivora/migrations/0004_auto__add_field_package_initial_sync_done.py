...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Package.initial_sync_done'
        db.add_column('folivora_package', 'initial_sync_done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Package.initial_sync_done'
        db.delete_column('folivora_package', 'initial_sync_done')
